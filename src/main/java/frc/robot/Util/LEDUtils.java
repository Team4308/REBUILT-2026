...
public class LEDUtils {
    ...
    /**
     * Sets the color for a scrolling idle pattern that fades between a base color
     * and white.
     * 
     ...
     */
    private static void setBlendedColor(AddressableLEDBufferView buffer, int index, Color baseColor,
            double blendFactor) {
