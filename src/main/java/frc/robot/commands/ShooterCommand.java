...
public class ShooterCommand extends Command {
  ...
  public void setState(ShooterSubsystem.ShooterState state) {
 ...
 * speed to pass to our zone. Specific location will be in strategy DONE
