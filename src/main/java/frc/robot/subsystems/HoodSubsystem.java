...
public class HoodSubsystem extends SubsystemBase {
    ...
    private boolean usingStateBased = false;
    ...
    public double getHoodAngle() {
        return angleOffset + (m_hoodMotor.getPosition().getValueAsDouble()) * Constants.Hood.TOTAL_GEAR_RATIO / 360;
    }
    ...
    public Command resetHoodCommand() {
        return run(this::resetHood).until(() -> m_hoodMotor.getSupplyCurrent().getValueAsDouble() > 20.0)
    ...
    public void setUsingStateBased(boolean usingStateBased) {
        this.usingStateBased = usingStateBased;
    }
    ...
    public void periodic() {
        ...
        Logger.recordOutput("Subsystems/Hood/Voltage", ffVolts);
    }
}